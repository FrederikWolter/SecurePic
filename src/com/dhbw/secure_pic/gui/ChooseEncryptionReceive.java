...
public class ChooseEncryptionReceive {
    ...
    public ChooseEncryptionReceive(){
        ...
        noEncryptionInf = new JLabel("Receive information no Encryption");
        symmetricInf = new JLabel("Receive Information symmetric");
        asymmetricInf = new JLabel("Receive Information asymmetric");
