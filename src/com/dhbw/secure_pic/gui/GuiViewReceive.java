            ...
            DecodeTask task = new DecodeTask(coder, crypter, info -> {
                ...
                if (type == Information.Type.TEXT) {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, MessageFormat.format(bundle.getString("popup.msg_diyplay_error"), ex.getMessage()), bundle.getString("popup.title.error"), JOptionPane.ERROR_MESSAGE);
                    }
                } else {
                    JOptionPane.showMessageDialog(null, MessageFormat.format(bundle.getString("popup.msg.error_unkonw_information_type"), type), bundle.getString("popup.title.error"), JOptionPane.ERROR_MESSAGE);
                }
